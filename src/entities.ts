...
import * as entity8 from './modules/pod/entity/item';
import * as entity9 from './modules/pod/entity/batch';
import * as entity10 from './modules/pod/entity/provider';
...
import * as entity15 from './modules/base/entity/base';
import * as entity16 from './modules/base/entity/sys/user_role';
import * as entity17 from './modules/base/entity/sys/user';
import * as entity18 from './modules/base/entity/sys/role_menu';
import * as entity19 from './modules/base/entity/sys/role_department';
import * as entity20 from './modules/base/entity/sys/role';
import * as entity21 from './modules/base/entity/sys/param';
import * as entity22 from './modules/base/entity/sys/menu';
import * as entity23 from './modules/base/entity/sys/log';
import * as entity24 from './modules/base/entity/sys/department';
import * as entity25 from './modules/base/entity/sys/conf';
